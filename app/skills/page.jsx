...
const Skills = () => {
  return (
    <section className="container mx-auto bg-quarterary dark:bg-primary text-primary dark:text-quarterary py-6 px-4">
      <div className="grid grid-cols-1 grid-rows-1  py-4 ">
        ...
        <div className=" grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 md:gap-4 sm:gap-2 place-items-center py-2">
          {skills.map((skill) => (
